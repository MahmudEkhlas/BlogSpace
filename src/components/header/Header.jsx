                ...
                <li key={item.name}>
                  <NavLink
                    ...
                    className={({ isActive }) =>
                              ...
                              // change of colors depending on that button is active
                                ${isActive 
                                  ? "text-blue-600 bg-gray-200 dark:text-cyan-400 dark:bg-cyan-400/10" 
                                  : "text-gray-700 dark:text-gray-300 hover:text-gray-950 dark:hover:text-cyan-400 hover:bg-gray-200 dark:hover:bg-cyan-400/10"}
